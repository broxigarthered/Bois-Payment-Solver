...
class BoisTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        do {
            ...
            self.products = result as! [NSManagedObject]
        } catch {
            print("Failed")
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "reuseIdentifier", for: indexPath) as! BoiVCCell
        
        cell.name.text = Array(self.boisPrice.keys)[indexPath.row]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "showBoiInfo" {
            if let destinationController =  segue.destination as? BoiViewController{
                ...
                destinationController.boiName = cell.name.text!
